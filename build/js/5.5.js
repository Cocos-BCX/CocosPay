...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(903);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21794575_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(934);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-21794575"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21794575_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/popup/pages/login/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21794575", Component.options)
  } else {
    hotAPI.reload("data-v-21794575", Component.options)
  }
...
exports.default = {
  ...
  data: function data() {
    ...
    var accountPass = function accountPass(rule, value, callback) {
      if (!_this.cocosAccount.accounts) {
        if (value === "") {
          callback(new Error(_this.$i18n.t("verify.accountNull")));
        } else {
          callback();
        }
      } else {
  ...
  computed: (0, _extends3.default)({}, (0, _vuex.mapState)("wallet", ["accounts", "pwdhash", "password"]), (0, _vuex.mapState)(["cocosAccount", "isLogin", "isAccount"])),
  methods: (0, _extends3.default)({}, (0, _vuex.mapActions)("wallet", ["setSeed"]), (0, _vuex.mapMutations)("wallet", ["setPassword", "upgradeAccounts"]), (0, _vuex.mapMutations)(["upgradeCurrentAccount", "setAccount", "setLogin", "setIsAccount"]), (0, _vuex.mapActions)("account", ["loadBCXAccount", "loginBCXAccount", "logoutBCXAccount"]), {
    ...
    //解锁账户
    unLock: function unLock(formName) {
      var _this2 = this;

      this.$refs[formName].validate(function (valid) {
        if (valid) {
          _this2.setAccount({
            account: _this2.cocosAccount.accounts || _this2.formData.account,
            password: _this2.formData.password
          });
          _this2.loginBCXAccount().then(function (res) {
            if (res.code === 1) {
              _this2.setAccount({
                account: _this2.cocosAccount.accounts,
                password: ""
              });
              _this2.setIsAccount(true);
              _this2.setLogin(true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(29)("b3eaf5c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js?{\"minimize\":false}!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-21794575\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/sass-loader/lib/loader.js?{}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js?{\"minimize\":false}!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-21794575\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/sass-loader/lib/loader.js?{}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("navigation", { attrs: { title: _vm.$t("title.importAccount") } }),
      _vm._v(" "),
      _vm._m(0),
      _vm._v(" "),
          ...
          _c(
            ...
            [
              _c("el-input", {
                ...
                attrs: {
                  type: "text",
                  placeholder: _vm.$t("placeholder.account")
                },
                model: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-21794575", esExports)
  }
}
